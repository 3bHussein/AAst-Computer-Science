...
#include<graphics.h>   //for textcolor & textbackground
	...
	cout<<"\n";
	cputs ("                         WELCOME TO THE HARDWARE COMPUTERS                       \n");
	printf("********************************************************************************\n");
	printf("********************************************************************************\n");
	gotoxy(2,21);
	textcolor(GREEN);
	 cputs("                   COLLEGE:- UNIVERSAL COLLEGE OF ENGINEERING AND TECHNOLOGY                   ");
	 gotoxy(2,22);
	 cputs("                              KAMAN VASAI                               ");
	 cout<<"\n";
	printf("********************************************************************************\n");
	...
	gotoxy(1,29);
	textcolor(BROWN);
	 cputs("                        SUBJECT SIR:-MR.RAVI NAGAR                        \n");
	 cout<<"\n\n";
	printf("********************************************************************************\n");
	printf("********************************************************************************\n");
	gotoxy(1,37);
	textcolor(LIGHTGRAY);
	 cputs("                              BY:- PRAFUL KUDIKALA                             \n");
	 gotoxy(1,39);
	 cputs("                              CLASS:- SE-COMPS SEM-III                             \n");
	 gotoxy(1,41);
	 cputs("                              ROLL NO:- 42                               \n");
	 gotoxy(1,43);
